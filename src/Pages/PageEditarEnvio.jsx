...
const PageEditarEnvio = () => {
  ...
  const { singleOrder, singleOrderLoading, editingOrder } =
  ...
  React.useEffect(() => {
    !singleOrder && dispatch(orderDetail(orderId));
  ...
  React.useEffect(() => {
    ...
    setValue(
      'receiving_company_RUC',
      singleOrder?.receiving_company_RUC
    );
    ...
    setValue('delivery_date', dayjs(singleOrder?.delivery_date));
                  ...
                  >
                    ...
                    >
                      <DatePicker
                        ...
                        // defaultValue={dayjs(watch().pick_up_date)}
                        value={watch().pick_up_date || null} // Debes establecer el valor de DatePicker, puedes usar null o una fecha inicial
                        onChange={(date) =>
                  ...
                  >
                    ...
                    >
                      <TimeField
                        ...
                        defaultValue={
                          singleOrder?.pick_up_time
                            ? dayjs()
                                .hour(
                                  parseInt(
                                    singleOrder?.pick_up_time.split(
                                      ':'
                                    )[0],
                                    10
                                  )
                  ...
                  >
                    ...
                    >
                      <DatePicker
                        ...
                        // defaultValue={dayjs(watch().delivery_date)}
                        value={watch().delivery_date || null} // Debes establecer el valor de DatePicker, puedes usar null o una fecha inicial
                        onChange={(date) =>
                        ...
                        defaultValue={
                          singleOrder?.delivery_time
                            ? dayjs()
                                .hour(
                                  parseInt(
                                    singleOrder?.delivery_time.split(
                                      ':'
                                    )[0],
                                    10
                                  )
